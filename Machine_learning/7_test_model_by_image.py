...
PATH_TO_CKPT = '/home/adas/Documents/Traffic_sign_detection/output_model/12_09/frozen_inference_graph.pb'

# Path to label map file
PATH_TO_LABELS = '/home/adas/Documents/Traffic_sign_detection/NA_traffic_sign_map.pbtxt'

# Path to image
PATH_TO_IMAGE = '/media/adas/New Volume/RSA/states/CA'

label_path = PATH_TO_IMAGE+'/labelled'
try:
    os.mkdir(label_path)
except OSError:
